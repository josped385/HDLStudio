...
class FileExplorer(QTreeView):
    ...
    def _show_context_menu(self, pos):
        ...
        elif chosen in menu.actions() and chosen.text() in ("Compile", "Run", "View Waves", "Generate Testbench", "Synthesize", "Show Schematic", "Place & Route"):
